...
const { sanitizeUser, sendMail } = require("../services.js/common");
...
exports.resetPasswordRequest = async (req, res) => {
  ...
  if (user) {
    ...
    const html = `<p>Click <a href='${resetPageLink}'> here </a>to Rest Password</p>`;
  ...
  if (user) {
    ...
    crypto.pbkdf2(
      ...
      async function (err, hashedPassword) {
        ...
        const subject = "Password Reset Successfull for your Email on our E-commerce";
